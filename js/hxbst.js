var BST = function() { //建树
    ...
    this.postorderTraversal = function() {
      ...
      if (internalBst["root"] == null) {
        ...
        postorderTraversalRecursion(internalBst["root"]);
      }
      ...
      function postorderTraversalRecursion(currentVertex) {
        ...
        if (currentVertexLeftChild == null) {
		  ...
		  if (currentVertexRightChild == null) {
            ...
            cs["lineNo"] = 3;
            stateList.push(cs);
            postorderTraversalRecursion(currentVertexRightChild);
          }
        } else {
          ...
          cs["lineNo"] = 3;
          stateList.push(cs);
          postorderTraversalRecursion(currentVertexLeftChild);
		  if (currentVertexRightChild == null) {
            vertexTraversed[currentVertex] = true;
            cs = createState(internalBst, vertexTraversed, edgeTraversed);
            cs["status"] = + currentVertex + " 的右孩子为空";
        ...
        cs["status"] = "后序遍历 " + currentVertex + " 成功";
        cs["lineNo"] = 0;
        stateList.push(cs);
      }

      function postorderHighlightVertex() {
        var key;
      ...
      for (i = 0; i < vertexTextArr.length; i++) {
        ...
        if (isAVL) {
          ...
          while (vertexCheckBf != null) {
            ...
            cs["status"] = "Balance factor of " + vertexCheckBf + " is " + bf + ".";
            cs["lineNo"] = 2;
            stateList.push(cs);
            ...
            if (bf == 2) {
              ...
              cs["status"] = "And balance factor of " + vertexCheckBfLeft + " is " + bfLeft + ".";
              cs["lineNo"] = 2;
              stateList.push(cs);
              ...
              if (bfLeft == 1 || bfLeft == 0) {
                ...
                cs["status"] = "Rotate right " + vertexCheckBf + ".";
                cs["lineNo"] = 3;
                stateList.push(cs);
                ...
                cs["status"] = "Rotate left " + vertexCheckBfLeft + ".";
                cs["lineNo"] = 4;
                stateList.push(cs);
              ...
              cs["status"] = "And balance factor of " + vertexCheckBfRight + " is " + bfRight + ".";
              cs["lineNo"] = 2;
              stateList.push(cs);
              ...
              if (bfRight == 1) {
                ...
                cs["status"] = "Rotate right " + vertexCheckBfRight + ".";
                cs["lineNo"] = 6;
                stateList.push(cs);
                ...
                if (internalBst["root"] != vertexCheckBfRightLeft)
                  cs["el"][vertexCheckBfRightLeftClass]["state"] = EDGE_HIGHLIGHTED;
                cs["status"] = "Rotate left " + vertexCheckBf + ".";
                cs["lineNo"] = 6;
                stateList.push(cs);
    ...
    this.removeArr = function(vertexTextArr) {
      ...
      for (i = 0; i < vertexTextArr.length; i++) {
        ...
        // Case 3: two children
          ...
          cs["status"] = "Finding successor of " + vertexText;
          if (!isAVL) {
            cs["lineNo"] = 6;
          } else {
            cs["lineNo"] = 1;
          ...
          cs["status"] = "Replace node " + vertexText + " with its successor";
          if (!isAVL) {
            cs["lineNo"] = 6;
          } else {
            cs["lineNo"] = 1;
        ...
        cs = createState(internalBst);
        cs["status"] = "Removal of " + vertexText + " completed";
        if (!isAVL) {
          cs["lineNo"] = 0;
        } else {
          cs["lineNo"] = 1;
    ...
    function populatePseudocode(act) {
      switch (act) {
        ...
        case 9: // predecessor
          ...
          document.getElementById('code7').innerHTML = '&nbsp;&nbsp;else return p';
          break;
        case 10: // Pre-order traversal
          document.getElementById('code1').innerHTML = 'if this is null';
          document.getElementById('code2').innerHTML = '&nbsp;&nbsp;return';
          document.getElementById('code3').innerHTML = 'visit this, then inOrder(left)';
          document.getElementById('code4').innerHTML = 'inOrder(right)';
          document.getElementById('code5').innerHTML = '';
          document.getElementById('code6').innerHTML = '';
          document.getElementById('code7').innerHTML = '';
          break;
        case 11: // Post-order traversal
          document.getElementById('code1').innerHTML = 'if this is null';
          document.getElementById('code2').innerHTML = '&nbsp;&nbsp;return';
          document.getElementById('code3').innerHTML = 'inOrder(left)';
          document.getElementById('code4').innerHTML = 'inOrder(right),then visit this';
          document.getElementById('code5').innerHTML = '';
          document.getElementById('code6').innerHTML = '';
          document.getElementById('code7').innerHTML = '';
          break;
  ...
  var isPreorderOpen = false;
  var isPostorderOpen = false;
  ...
  function openPreorder() {
    if(!isPreorderOpen) {
      $('.preorder').fadeIn('fast');
      isPreorderOpen = true;
    }
  }
  function closePreorder() {
    if(isPreorderOpen) {
      $('.preorder').fadeOut('fast');
      $('#preorder-err').html("");
      isPreorderOpen = false;
    }
  }
  function openPostorder() {
    if(!isPostorderOpen) {
      $('.postorder').fadeIn('fast');
      isPostorderOpen = true;
    }
  }
  function closePostorder() {
    if(isPostorderOpen) {
      $('.postorder').fadeOut('fast');
      $('#postorder-err').html("");
      isPostorderOpen = false;
    }
  }
  //
  ...
  function postorderTraversal() {
    if (isPlaying) stop();
    setTimeout(function() {
      if ((mode == "exploration") && bstWidget.postorderTraversal()) {
        $('#current-action').show();
        $('#current-action p').html("后序遍历");
        $('#progress-bar').slider("option", "max", gw.getTotalIteration()-1);
        triggerRightPanels();
        isPlaying = true;
      }
