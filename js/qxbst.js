var BST = function() { //建树
    ...
    this.preorderTraversal = function() {
      ...
      if (internalBst["root"] == null) {
        ...
        preorderTraversalRecursion(internalBst["root"]);
      }
      ...
      function preorderTraversalRecursion(currentVertex) {
        ...
        if (currentVertexLeftChild == null) {
          ...
          cs["lineNo"] = 3;
          stateList.push(cs);
          preorderTraversalRecursion(currentVertexLeftChild);
        }
        ...
        if (currentVertexRightChild == null) {
          ...
          cs["lineNo"] = 3;
          stateList.push(cs);
          preorderTraversalRecursion(currentVertexRightChild);
        }
        ...
        cs["status"] = "前序遍历 " + currentVertex + " 成功";
        cs["lineNo"] = 0;
        stateList.push(cs);
      }

      function preorderHighlightVertex() {
        var key;
  ...
  function preorderTraversal() {
    if (isPlaying) stop();
    setTimeout(function() {
      if ((mode == "exploration") && bstWidget.preorderTraversal()) {
        $('#current-action').show();
        $('#current-action p').html("前序遍历");
        $('#progress-bar').slider("option", "max", gw.getTotalIteration()-1);
        triggerRightPanels();
        isPlaying = true;
      }
