// List Widget
    ...
    var List = function() {
        ...
        function populatePseudocode(act) {
            switch (act) {
                case 0: // Insert
                    $('#code1').html('Vertex temp1 = head');
                    $('#code2').html('while (--k!=0)');
                    $('#code3').html('&nbsp&nbsptemp1 = temp1.next');
                    $('#code4').html('Vertex temp2 = temp1.next');
                    $('#code5').html('Vertex newVertex = new Vertex(input)');
                    if ((activeStatus == "doublylist") || (activeStatus == "deque")) {
                        $('#code6').html('newVertex.next = temp2 , temp2.prev = newVertex');
                        $('#code7').html('temp1.next = newVertex , newVertex.prev = temp1');
                    } else {
                        $('#code6').html('temp1.next = newVertex');
                        $('#code7').html('newVertex.next = temp2');
                    }
                    break;
                case 1: // insertHead
                    $('#code1').html('Vertex temp = new Vertex(input)');
                    $('#code2').html('temp.next = head');
                    if ((activeStatus == "doublylist") || (activeStatus == "deque")) {
                        if (amountVertex == 1) {
                            $('#code3').html('if (head!=null) head.prev = temp');
                            $('#code4').html('head = temp');
                ...
                case 2: // insertTail
                    $('#code1').html('Vertex temp = new Vertex(input)');
                    $('#code2').html('tail.next = temp');
                    if ((activeStatus == "doublylist") || (activeStatus == "deque")) {
                        $('#code3').html('temp.prev = tail');
                        $('#code4').html('tail = temp');
                    } else {
                        $('#code3').html('tail = temp');
                        $('#code4').html('');
                    }
                    $('#code5').html('');
                    $('#code6').html('');
                ...
                case 5: // remove HEAD
                    ...
                    break;
                case 6: // remove TAIL
                    $('#code1').html('Vertex prev = head');
                    $('#code2').html('temp = head.next');
                    $('#code3').html('while (temp.next!=null)');
                    $('#code4').html('&nbsp&nbsptemp = temp.next , prev = prev.next');
                    $('#code5').html('prev.next = null');
                    $('#code6').html('delete temp');
                    $('#code7').html('tail = prev');
                    break;
                case 7: // remove kth
                    $('#code1').html('Vertex cur = head');
                    $('#code2').html('while (--k!=0)');
                    $('#code3').html('&nbsp&nbspcur = cur.next');
                    $('#code4').html('Vertex tobedeleted = cur.next');
                    if ((activeStatus == "doublylist") || (activeStatus == "deque")) {
                        $('#code5').html('Vertex temp = tobedeleted.next');
                        $('#code6').html('delete tobedeleted');
                        $('#code7').html('cur.next = temp, temp.prev = cur');
                    } else {
                        $('#code5').html('cur.next = cur.next.next');
                        $('#code6').html('delete tobedeleted');
                        $('#code7').html('');
                    }
                    break;
                case 8: //remove tail doubly list
                    $('#code1').html('temp = tail');
                    $('#code2').html('tail = tail.prev');
