var HashTable = function() {
  ...
  function populatePseudocode(act) {
    ...
    switch (act) {
      case 0: // search
        $('#code1').html('i = base = key%HT.length // get hashed index');
        ...
        $('#code5').html('&nbsp&nbspelse i = (base+step*' + jump + ')%HT.length');
        $('#code6').html((activeStatus == "DH" ? '// sec = prime - key%prime' : ''));
        $('#code7').html('');
        break;
      case 1: // insert
        $('#code1').html('if HT is 1 item before full, prevent insertion');
        $('#code2').html('i = base = key%HT.length // get hashed index');
        $('#code3').html('while (HT[i] != EMPTY || HT[i] != DELETED)');
        $('#code4').html('&nbsp;&nbsp;i = (base+step*' + jump + ')%HT.length');
      ...
      case 2: // remove
        $('#code1').html('i = base = key%HT.length // get hashed index');
        $('#code2').html('while (true)');
        $('#code3').html('&nbsp&nbspif (HT[i] == EMPTY) break // key not found');
        $('#code4').html('&nbsp&nbspelse if (HT[i] == key)');
        $('#code5').html('&nbsp&nbsp&nbsp&nbspHT[i] = DELETED');
        $('#code6').html('&nbsp&nbspelse i = (base+step*' + jump + ')%HT.length');
